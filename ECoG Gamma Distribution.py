...
dyskinesia_group     = ECOG_PSD_noLID
...
def map_ecog_to_brain(ecog_df, brain_surface,feature):
    ...
    - brain_surface: PyVista PolyData object representing the brain surface.
...
brain_cloud_with_ecog = map_ecog_to_brain(ECoG_channel_dynamics, cortex_right, feature)
###############################################################################
plotter        = pv.Plotter()
...
plotter.add_mesh(brain_cloud_with_ecog, point_size=10, scalars=feature, cmap='viridis', clim=[-50, 150], render_points_as_spheres=True)
scalar_bar_args = {
    'title': feature,
